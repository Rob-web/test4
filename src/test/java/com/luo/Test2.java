...
//              gc.setSwagger2(true);//实体属性Swagger2注解
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/springboot_test?serverTimezone=UTC");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("luoshun5589118");
        ...
        strategy.setInclude("tb_chemical_channel");//需要生成的表,可以使用正则表达式
        strategy.setNaming(NamingStrategy.underline_to_camel);//下划线转驼峰
        strategy.setColumnNaming(NamingStrategy.underline_to_camel);//字段生成驼峰
        strategy.setTablePrefix("tb");//不生成表的前缀
